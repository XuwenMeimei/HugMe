 ...
 * {@link nya.tuyw.hugme.mixin.LivingEntityRendererMixin}: the animation moves the model about a
...
public final class HugOverlayHandler {
    ...
    public static void onRenderNameTag(RenderNameTagEvent event) {
        if (event.getEntity() instanceof Player player && HugClientState.lockOf(player.getUUID()) != null) {
